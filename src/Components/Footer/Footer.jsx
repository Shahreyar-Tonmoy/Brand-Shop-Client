        ...
        <div className="bg-[#bda3a3] text-white mt-20 " >
            <footer className="footer text-white py-10 lg:px-20   max-w-screen-xl mx-auto">
                <aside>
                    ...
                    <p className="ml-10">Fashion Store Ltd.<br />Providing reliable tech since 1992</p>
                </aside>
                ...
                <nav className='mx-auto'>
                    ...
                    <a className="link link-hover">Language Packs</a>
                    <a className="link link-hover">Release Status</a>
                </nav>
