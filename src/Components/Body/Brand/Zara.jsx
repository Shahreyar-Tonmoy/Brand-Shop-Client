...
const Zara = () => {
    ...
    const filter =data.filter(e => e.brand.toLowerCase().includes("Zara".toLowerCase()) )
  
    return (
        <div>
            <ZaraSlider></ZaraSlider>
            <h1 className="max-w-screen-xl text-center mx-auto text-2xl font-semibold underline my-10">Our Product</h1>
