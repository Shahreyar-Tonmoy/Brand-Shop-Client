...
const Levies = () => {
    ...
    const filter =data.filter(e => e.brand.toLowerCase().includes("Levi's".toLowerCase()) )
  
    return (
        <div>
            <LeviesSlider></LeviesSlider>
            <h1 className="max-w-screen-xl mx-auto text-center text-2xl font-semibold underline my-10">Our Product</h1>
